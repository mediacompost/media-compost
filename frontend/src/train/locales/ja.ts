...
const CATALOG: Catalog = {
  ...
  "Delete every result in this session": "このセッションのすべての結果を削除",
  "Session": "セッション",
  "No adapters": "アダプターなし",
  "Delete every result in this group": "このグループの結果をすべて削除",
  "Delete all {n} results in this group?": "このグループの {n} 件の結果をすべて削除しますか？",
  ...
  "Delete all {n} results from this session?": "このセッションの {n} 件の結果をすべて削除しますか？",
  "The generated images go with them.": "生成された画像も一緒に消えます。",
