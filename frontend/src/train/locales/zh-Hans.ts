...
const CATALOG: Catalog = {
  ...
  "Delete every result in this session": "删除此会话的所有结果",
  "Session": "会话",
  "No adapters": "无适配器",
  "Delete every result in this group": "删除此组中的所有结果",
  "Delete all {n} results in this group?": "删除此组中的全部 {n} 个结果？",
  ...
  "Delete all {n} results from this session?": "删除此会话的全部 {n} 个结果吗？",
  "The generated images go with them.": "生成的图像会一并删除。",
