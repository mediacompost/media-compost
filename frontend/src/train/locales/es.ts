...
const CATALOG: Catalog = {
  ...
  "Delete every result in this group": "Eliminar todos los resultados de este grupo",
  "Delete all {n} results in this group?": "¿Eliminar los {n} resultados de este grupo?",
  ...
  "No adapters for this base model yet.": "Aún no hay adaptadores para este modelo base.",
  "No trained adapters yet.": "Aún no hay adaptadores entrenados.",
